    ...
    <div>
          ...
          <div className="flex flex-col md:flex-row justify-between gap-10">
            ...
            <div className="w-full md:w-1/5">
              <Link to="/" className="text-orange-600 font-bold text-xl">
                Naukri<span className="text-[#fb923c]"> Chakri</span>
              </Link>
              <p className="mt-4 ">
                Naukri Chakri is your ultimate platform for finding jobs and connecting with companies. We aim to simplify job searching and hiring processes.
              </p>
      ...
      <div className="bg-[#EEE6DB] dark:bg-gray-800 py-5 flex justify-center items-center">
        <p className=" text-sm text-center sm:text-left">
          Copyright&copy; 2024 by Naukri Chakri. All rights reserved.
        </p>
      </div>
    </div>
  );
